    ...
    <n-layout-content>
      <n-layout has-sider style="height: 100%" :key="locale && locale.name">
        ...
        <n-layout-sider
          class="_fc-l"
          v-if="!hiddenLeft"
          :width="activeModule === 'language' ? 450 : 266"
        >
          ...
          <n-layout style="height: 100%" v-if="activeModule === 'base'">
            <n-layout-header style="height: 40px" class="_fc-l-tabs">
              <div
                class="_fc-l-tab"
            ...
            <n-layout-content v-if="activeMenuTab === 'tree'">
              <n-tree
                ...
                @update:selected-keys="treeChange"
              >
                  ...
                  >
                    ...
                    <div class="_fc-tree-more" @click.stop v-if="!data.slot">
                      <n-dropdown
                        ...
                        "
                        @select="(key) => toolHandle(data.rule, key)"
                      >
        ...
        <n-layout has-sider class="_fc-m">
          ...
          <n-layout-content class="_fc-m-con">
            ...
            <div class="_fc-m-input-handle" v-if="inputForm.state">
              <n-button secondary @click="inputClear()">{{
                t("props.clear")
              }}</n-button>
              <n-button secondary @click="inputReset()">{{
                t("props.reset")
              }}</n-button>
              <n-button type="primary" secondary @click="inputSave()">{{
                t("props.save")
              }}</n-button>
            </div>
          </n-layout-content>
        ...
        >
          ...
          <n-layout has-sider style="height: 100%">
            <n-layout-header style="height: 40px" class="_fc-r-tabs">
              <div
                class="_fc-r-tab"
            ...
            >
              ...
              >
                <div style="grid-area: base">
                  <n-divider v-if="baseForm.isShow">{{
                    t("designer.rule")
                  }}</n-divider>
                  <DragForm
                ...
                <div style="grid-area: props">
                  <n-divider v-if="propsForm.isShow"
                    >{{ t("designer.props") }}
                    <PropsInput
                ...
                <div style="grid-area: style">
                  <n-divider v-if="styleForm.isShow" id="_fd-config-style"
                    >{{ t("designer.style") }}
                  </n-divider>
                  <DragForm
        ...
        >
          <n-tabs class="_fd-preview-tabs" v-model:value="previewStatus">
            ...
            <n-tab-pane
              ...
              name="component"
            ></n-tab-pane>
            <n-tab-pane :label="t('form.htmlMode')" name="html"></n-tab-pane>
          </n-tabs>
          <div
